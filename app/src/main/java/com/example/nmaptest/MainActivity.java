...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list2.add("부산근대역사관");
        list2.add("부산영화체험박물관");
        ArrayAdapter<String> jungguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list2);
        List<String> list3 = new ArrayList<>();
        list3.add("송도해수욕장");
        list3.add("송도해상케이블카");
        list3.add("암남공원");
        ArrayAdapter<String> seoguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list3);
        List<String> list4 = new ArrayList<>();
        list4.add("중앙공원");
        list4.add("차이나타운");
        list4.add("이바구길모노레일");
        ArrayAdapter<String> dongguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list4);
        List<String> list5 = new ArrayList<>();
        list5.add("태종대");
        list5.add("흰여울문화마을");
        list5.add("국립해양박물관");
        ArrayAdapter<String> youngdoguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list5);
        List<String> list6 = new ArrayList<>();
        list6.add("부산시민공원");
        list6.add("황령산봉수대");
        list6.add("전포카페거리");
        ArrayAdapter<String> jinguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list6);
        List<String> list7 = new ArrayList<>();
        list7.add("허심청");
        list7.add("금강공원");
        list7.add("부산해양자연사박물관");
        ArrayAdapter<String> dongreguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list7);
        List<String> list8 = new ArrayList<>();
        list8.add("오륙도스카이워크");
        list8.add("이기대수변공원");
        list8.add("우암동도시숲");
        ArrayAdapter<String> namguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list8);
        List<String> list9 = new ArrayList<>();
        list9.add("백양산웰빙숲");
        list9.add("화명수목원");
        list9.add("덕천동젊음의거리");
        ArrayAdapter<String> bokguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list9);
        List<String> list10 = new ArrayList<>();
        list10.add("해운대해수욕장");
        list10.add("동백섬");
        list10.add("BEXCO");
        ArrayAdapter<String> heundeguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list10);
        List<String> list11 = new ArrayList<>();
        list11.add("감천문화마을");
        list11.add("을숙도생태공원");
        list11.add("장림포구");
        ArrayAdapter<String> sahaguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list11);
        List<String> list12 = new ArrayList<>();
        list12.add("스포원파크");
        list12.add("오륜대전망대");
        list12.add("금강식물원");
        ArrayAdapter<String> gemjungguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list12);
        List<String> list13 = new ArrayList<>();
        list13.add("정거마을문화거리");
        list13.add("대항전망대");
        list13.add("가덕도등대");
        ArrayAdapter<String> gangseoadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list13);
        List<String> list14 = new ArrayList<>();
        list14.add("온천시민공원");
        list14.add("대영해수온천");
        list14.add("녹음광장");
        ArrayAdapter<String> yuenjeguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list14);
        List<String> list15 = new ArrayList<>();
        list15.add("민락수변공원");
        list15.add("광안리해수욕장");
        list15.add("수영사적공원");
        ArrayAdapter<String> soyoungguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list15);
        List<String> list16 = new ArrayList<>();
        list16.add("삼락생태공원");
        list16.add("사상근린공원");
        list16.add("사상생활사박물관");
        ArrayAdapter<String> sasangguadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list16);
        List<String> list17 = new ArrayList<>();
        list17.add("워터하우스");
        list17.add("치유의숲");
        list17.add("국립부산과학관");
        ArrayAdapter<String> gijanggunadpater = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, list17);//명소셋팅
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l)
            {
                ...
                {
                    listView1.setAdapter(jungguadpater);
                ...
                {
                    listView1.setAdapter(seoguadpater);
                ...
                {
                    listView1.setAdapter(dongguadpater);
                ...
                {
                    listView1.setAdapter(youngdoguadpater);
                ...
                {
                    listView1.setAdapter(jinguadpater);
                ...
                {
                    listView1.setAdapter(dongreguadpater);
                ...
                {
                    listView1.setAdapter(namguadpater);
                ...
                {
                    listView1.setAdapter(bokguadpater);
                ...
                {
                    listView1.setAdapter(heundeguadpater);
                ...
                {
                    listView1.setAdapter(sahaguadpater);
                ...
                {
                    listView1.setAdapter(gemjungguadpater);
                ...
                {
                    listView1.setAdapter(gangseoadpater);
                ...
                {
                    listView1.setAdapter(yuenjeguadpater);
                ...
                {
                    listView1.setAdapter(soyoungguadpater);
                ...
                {
                    listView1.setAdapter(sasangguadpater);
                ...
                {
                    listView1.setAdapter(gijanggunadpater);
