...
public class FragmentMap extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ListView regionListview = rootView.findViewById(R.id.placeListview);
        ...
        listView.setOnItemClickListener((adapterView, view, position, l) -> {
            ...
            if(data == "경주")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView1, view1, position1, l1) -> {
            ...
            else if(data == "중구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView12, view12, position12, l12) -> {
            ...
            else if(data == "서구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView13, view13, position13, l13) -> {
            ...
            else if(data == "동구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView14, view14, position14, l14) -> {
            ...
            else if(data == "영도구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView15, view15, position15, l15) -> {
            ...
            else if(data == "부산진구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView16, view16, position16, l16) -> {
            ...
            else if(data == "동래구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView17, view17, position17, l17) -> {
            ...
            else if(data == "남구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView18, view18, position18, l18) -> {
            ...
            else if(data == "북구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView19, view19, position19, l19) -> {
            ...
            else if(data == "해운대구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView110, view110, position110, l110) -> {
            ...
            else if(data == "사하구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView111, view111, position111, l111) -> {
            ...
            else if(data == "금정구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView112, view112, position112, l112) -> {
            ...
            else if(data == "강서구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView113, view113, position113, l113) -> {
            ...
            else if(data == "연제구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView114, view114, position114, l114) -> {
            ...
            else if(data == "수영구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView115, view115, position115, l115) -> {
            ...
            else if(data == "사상구")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView116, view116, position116, l116) -> {
            ...
            else if(data == "기장군")
            {
                ...
                // 관광지로 카메라이동
                regionListview.setOnItemClickListener((adapterView117, view117, position117, l117) -> {
